...
import { completeSessionHandoff, googleCallback, googleLogin, logout, me } from '../controllers/auth.controller.js';
...
authRouter.post('/session/complete', completeSessionHandoff);
